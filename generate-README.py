...
def generate_README(article):
    ...
    content = (
        ...
        "**Keywords:** {_.keywords}\n"
        "\n"
        "**A Replication of** [{_.replication.bib}](http://doi.org/{_.replication.doi})  \n"
        "\n"
        "----\n"
        "\n"
        ...
        "**Corresponding author**: {_.contact.name} ([{_.contact.email}](mailto:{_.contact.email}))  \n"
