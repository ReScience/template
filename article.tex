...
\fancypagestyle{titlepage} {
  ...
  \chead{
   ...
   \normalsize \noindent \vspace{-3mm} \articleHEAD
  }
  \renewcommand{\headrulewidth}{0.0pt}
  \renewcommand{\footrulewidth}{0.0pt}
...
\lfoot{\footnotesize \sf ReScience \articleVOLUME:\articleNUMBER}
...
\noindent {\bfseries Keywords:} \articleTAGS\\

\noindent {\bfseries A replication of } \fullcite{\replicationBIB}.
...
\newgeometry{
  left=3cm, right=3cm, top=1.0cm, bottom=1.5cm,
