...
\geometry{marginparsep=0.5cm, marginpar=4.0cm}
...
\begin{tikzpicture}[remember picture, overlay]
  \node [shift={(-3.5cm,-3.5cm)}] at (current page.north east) {
     \begin{tikzpicture}[remember picture, overlay]
...
\hypersetup{
  ...
  pdfsubject={\articleDOMAIN},
  pdfcreator={Latex & Biber},
  pdfproducer={ReScience (rescience.github.io)}
}
