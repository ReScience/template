...
\fancypagestyle{titlepage} {
  ...
  \chead{
   ...
   \noindent\vspace{-3mm}\footnotesize Reproducible Science is Good,
                                       Replicated Science is Better.
  }
  \renewcommand{\headrulewidth}{0.0pt}
  \renewcommand{\footrulewidth}{0.0pt}
  \cfoot{\vfill \small \sf \href{https://rescience.github.io}{rescience.github.io}\\
...
\noindent {\bfseries \sffamily Abstract}. \articleABSTRACT\\

\noindent {\bfseries \sffamily Keywords:} \articleTAGS
